...
| `expenses`                                           | Finance                            | New manual, recurring, OTA commission, platform fee and supplier bill ledger.                               | Supplier bills bind reciprocally to one supplier invoice; corrections and reversals are append-only; P&L is computed.                            |
