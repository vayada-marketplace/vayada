...
| `invoices`                                           | Finance                            | New persisted invoice headers with optional Booking references.                                             | Stored lifecycle is draft, issued or voided; sent, partial, paid and overdue are derived later.                                                  |
