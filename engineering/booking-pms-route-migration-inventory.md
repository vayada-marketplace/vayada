...
| `POST /admin/import/preview`, `POST /admin/import/confirm`, `POST /admin/import/images`, `POST /upload/images`                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | PMS, VA upload helpers | Partially migrated | `POST /upload/images` is retired. Import preview/confirm remain PMS commands; image side effects now queue platform media import jobs via `/api/media/imports`. See `engineering/booking-pms-media-route-retirement.md`. |
