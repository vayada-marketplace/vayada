...
`assertAffiliateCaptureRoleHasNoWriteGrants`. It rejects a candidate login
with owner or DDL powers, membership, direct table or column writes, sequence
rights, or delegated table/column reads. Its PostgreSQL fixture verifies that direct
click, admission, binding and mutable-hotel grants are rejected. This is a
