...
| VAY-646                   | vayada#410 | Guest phone required/optional setting must exist across admin settings, public checkout settings, and booking submission validation. Optional phone must allow direct bookings with an empty phone value.                                             |
