...
Migration `0193_membership_product_access.sql` stores independent PMS and Booking
...
This requires migration 0196 before runtime deployment. No role references are
