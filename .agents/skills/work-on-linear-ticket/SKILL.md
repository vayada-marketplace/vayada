...
This skill covers the full implementation lifecycle for a Vayada ticket: from loading context through opening a PR. Follow the six steps in order; do not skip or reorder them.
...
- Keep commits focused and descriptive. Each commit message should explain *why*, not just what changed.
