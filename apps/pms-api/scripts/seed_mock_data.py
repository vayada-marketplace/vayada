...
async def seed():
    ...
    room_types = [
        ...
        },
        {
            ...
            "bed_type": "Twin",
            "amenities": ["WiFi", "TV", "Air Conditioning", "Private Bathroom", "Mini Bar", "Safe", "Balcony"],
        ...
        },
        {
            ...
            "bed_type": "King",
            "amenities": ["WiFi", "TV", "Air Conditioning", "Private Bathroom", "Mini Bar", "Safe", "Espresso Machine", "Bathrobe", "Slippers", "Terrace"],
