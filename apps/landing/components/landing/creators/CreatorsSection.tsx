    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">{CREATORS_SECTION.subtitle}</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl p-8 lg:p-12 order-2 lg:order-1">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">How It Works for Creators</h3>
          ...
          <div className="order-1 lg:order-2">
            <h3 className="text-3xl font-bold text-gray-900 mb-6">Why Join vayada?</h3>
            <div className="space-y-6">
