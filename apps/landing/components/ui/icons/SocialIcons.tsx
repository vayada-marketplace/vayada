 ...
 * Centralized icons for Instagram, TikTok, YouTube, Facebook
 */
 ...
 * Returns the appropriate icon based on platform name
 */
export const PlatformIcon = ({
  ...
  if (
    platformLower.includes("content package") ||
    platformLower.includes("custom") ||
    platformLower.includes("deliverable")
  ) {
    return (
...
/**
 * Get platform icon as a function (for cases where JSX element is needed inline)
 * @deprecated Prefer using PlatformIcon component directly
 */
