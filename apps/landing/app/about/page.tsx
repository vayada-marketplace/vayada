      ...
      <main className="flex-1 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          ...
          <div className="text-center mb-12">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900">About Us</h1>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                Our journey began with a deep passion for boutique and independent hotels. Starting
                at 17 years old, it began with building the Instagram page{" "}
                <a
                ...
                to over 300,000 followers on Instagram, collaborating with hundreds of hotels
                worldwide.
              </p>

              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                But behind the beauty of travel, we discovered the same recurring struggle
                everywhere: OTA dominance, high commissions, and outdated systems that prevented
                especially small and independent properties from thriving.
              </p>
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                vayada is a platform that connects properties, travelers, and creators in one
                thriving, modern ecosystem, empowering each of them through transparency, fairness,
                and technology.
              </p>
            </div>
          </div>
              ...
              <div className="order-1 lg:order-2 space-y-12">
                ...
                <div>
                  ...
                  <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                    <p>
                      Our vision is to transform hospitality by giving independent hotels and
                      vacation rentals control over their bookings, data, and guest relationships.
                    </p>
                    <p>
                      We believe in a transparent, performance-driven ecosystem where properties
                      thrive through direct connections with travelers, supported by a global
                      network of trusted creators.
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-24 lg:mt-32">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <p className="text-gray-700 text-lg leading-relaxed max-w-3xl mx-auto mb-12">
                With over 300,000 followers, @glorioushotels has collaborated with 20+ boutique
                hotels and villas worldwide. These collaborations inspire vayada's mission to
                connect hotels, travelers, and creators in one powerful ecosystem.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  ...
                  >
                    <p className="text-gray-900 font-semibold text-lg">{partner}</p>
                  </div>
                ))}
              </div>
            </div>
