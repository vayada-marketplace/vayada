...
const plans = [
  {
    ...
    note: "Channel manager is not included on Commission. Upgrade to Subscription to sync inventory across OTAs.",
    cta: "Get started",
    highlighted: false,
  },
  {
        ...
        <div className="mx-auto max-w-7xl px-4 pb-14 sm:px-6 md:pb-20 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-500 md:text-xl">
              Start with zero risk. Move to a fixed monthly plan when direct bookings become a core
              channel.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-6 rounded-3xl border border-dashed border-border-strong bg-[#f7f8fc]/70 p-8 md:flex-row md:items-center md:justify-between">
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-sm leading-relaxed text-gray-500 md:text-base">
                  Use vayada&apos;s booking engine on top of your existing PMS with embeddable
                  checkout, affiliate and referral tracking, guest data export, and full API access.
                </p>
              </div>
              <Link
                href={ROUTES.CONTACT}
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 md:grid-cols-[0.8fr_1.2fr] lg:px-8">
          ...
          <div className="space-y-3">
            {faqs.map((faq) => (
              <details
                key={faq.question}
                className="group rounded-3xl border border-border bg-white p-6"
              >
