    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 max-w-md w-full text-center">
        ...
        <p className="text-sm text-gray-600">
          {hostname ? (
            <>
              <span className="font-mono">{hostname}</span> isn&apos;t connected to a property on
              Vayada yet.
            </>
          ) : (
        ...
        <p className="text-sm text-gray-600 mt-3">
          If you&apos;re the property owner, finish the Custom Domain step in your Booking Engine
          admin. Otherwise, please check the URL or contact the property directly.
        </p>
      </div>
    </div>
  );
