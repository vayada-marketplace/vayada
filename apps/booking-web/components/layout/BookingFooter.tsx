      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div>
            ...
            {/* Social Media Links */}
            {hotel.socialLinks && (hotel.socialLinks.instagram || hotel.socialLinks.facebook || hotel.socialLinks.twitter || hotel.socialLinks.youtube) && (
              <div className="flex items-center gap-3 mt-4">
                ...
                {hotel.socialLinks.twitter && (
                  <a href={hotel.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-white transition-colors" aria-label="Twitter">
