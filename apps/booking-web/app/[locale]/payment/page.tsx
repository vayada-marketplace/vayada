              ...
              {paymentMethod === "card" ? (
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-xl text-sm text-blue-700">
                    {depositRequired
                      ? hotel.instantBook
                        ? `Your booking will be confirmed instantly. You'll receive an email with our bank details for ${formatPrice(depositAmount, selectedCurrency)}. The remaining ${formatPrice(remainingBalance, selectedCurrency)} is due at the property.`
                        : `After we review and accept your booking, you'll receive an email with our bank details for ${formatPrice(depositAmount, selectedCurrency)}. The remaining ${formatPrice(remainingBalance, selectedCurrency)} is due at the property.`
                      : hotel.instantBook
