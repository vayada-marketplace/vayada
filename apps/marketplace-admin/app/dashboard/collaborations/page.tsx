...
export default function CollaborationsPage() {
  ...
  const fetchCollaborations = async () => {
    try {
      ...
      const response = await collaborationsService.getCollaborations(page, pageSize, {
        status: statusFilter,
  ...
  const columns: TableColumn<Collaboration>[] = [
        ...
        return (
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex items-center space-x-2">
              <span
                className={`text-[10px] font-bold uppercase w-12 ${isCreatorInitiator ? "text-blue-600" : "text-purple-600"}`}
              >
              ...
              <div className="flex items-center space-x-2 bg-gray-50 px-2 py-1 rounded-md border border-gray-100">
                {isCreatorInitiator ? (
                  ...
                  <>
                    <div className="w-4 h-4 rounded bg-purple-100 flex items-center justify-center text-[10px] font-bold text-purple-600">
                      H
                    </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2 px-2 py-1">
                {!isCreatorInitiator ? (
                  ...
                  <>
                    <div className="w-4 h-4 rounded bg-gray-100 flex items-center justify-center text-[10px] font-bold text-gray-500">
                      H
                    </div>
    ...
    },
    {
      ...
      header: "Status",
      render: (collab) => (
        <Badge variant={statusVariantMap[collab.status]}>{collab.status.toUpperCase()}</Badge>
      ),
    },
    {
      key: "created_at",
