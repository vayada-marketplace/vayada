...
export default function FinancialsPage() {
  ...
  return (
    <div data-testid="folios-workspace" className="p-4 md:p-6">
      <div className="mx-auto max-w-6xl space-y-5">
        ...
        {creating && canManage && (
          ...
          >
            <h2 className="sm:col-span-2 text-base font-semibold text-gray-900">Prepare a folio</h2>
              ...
              {items.map((item) => (
                ...
                >
                  ...
                  <span className="text-right">
                    <span className="block font-semibold text-gray-900">{money(item.total)}</span>
