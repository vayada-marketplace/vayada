      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            <label className="block text-sm font-medium text-gray-700">Rooms to Block</label>
              ...
              {roomsForType.map((r) => {
                ...
                return (
                  ...
                  >
                    ...
                    {r.floor && <span className="text-xs text-gray-500">Floor {r.floor}</span>}
                  </label>
                );
              })}
            </div>
        ...
        {confirmOverlap && overlappingBookings.length > 0 && (
          <div className="rounded-lg border border-amber-300 bg-amber-50 px-3 py-2 text-sm text-amber-800">
            ...
            <ul className="mt-1 list-inside list-disc space-y-0.5">
              ...
              {overlappingBookings.length > 5 && <li>+{overlappingBookings.length - 5} more</li>}
            </ul>
