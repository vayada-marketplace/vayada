...
class LodgifyConnectRequest(BaseModel):
    ...
    lodgify_property_id: str = Field(
        min_length=1, description="Lodgify property ID to bind this Vayada hotel to"
    )
...
class LodgifyConnectionStatus(BaseModel):
    ...
    lodgify_property_id: str | None = None
    lodgify_property_name: str | None = None
