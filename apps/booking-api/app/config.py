...
class Settings(BaseSettings):
    ...
    LODGIFY_API_BASE_URL: str = Field(
        "https://api.lodgify.com", description="Lodgify v2 API base URL"
    )
    LODGIFY_API_TIMEOUT: float = Field(
        15.0, description="Per-request timeout in seconds for Lodgify HTTP calls"
    )
