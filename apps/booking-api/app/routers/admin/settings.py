...
def _hotel_to_property_settings(hotel: dict) -> PropertySettingsResponse:
    return PropertySettingsResponse(
        ...
        default_language=hotel.get('default_language') or 'en',
        ...
        check_in_from=hotel.get('check_in_from') or '',
        check_in_until=hotel.get('check_in_until') or '',
        check_out_from=hotel.get('check_out_from') or '',
        check_out_until=hotel.get('check_out_until') or '',
        ...
        bank_transfer=hotel.get('bank_transfer', False),
        ...
        tiktok=hotel.get('social_tiktok') or '',
...
_DEFAULT_PROPERTY_SETTINGS = PropertySettingsResponse(
    ...
    default_language='en', supported_currencies=[], supported_languages=['en'],
    ...
    special_requests_enabled=True, arrival_time_enabled=False, guest_count_enabled=False,
