          ...
          <div className="bg-gray-100 rounded-lg p-1 inline-flex min-w-full md:min-w-0">
            {tabs.map((tab) => (
              <button
                ...
                className={`shrink-0 flex-1 md:flex-initial flex items-center justify-center gap-1.5 px-3 py-2 md:py-1.5 rounded-md text-[12px] md:text-[13px] whitespace-nowrap transition-all ${activeTab === tab.id
            ...
            {domainStatus?.configured ? (
              <div className="space-y-4 mt-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className={`inline-flex px-2 py-0.5 rounded-full text-[11px] font-medium ${domainStatus.ssl_status === 'active'
      ...
      {activeTab === 'billing' && (
        <div className="mt-5 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Commission Plan */}
            <div className={`bg-white rounded-lg border-2 p-5 transition-all ${settings.billing_active_plan === 'commission' && !settings.billing_pending_switch
            ...
            {/* Fixed Fee Plan */}
            <div className={`bg-white rounded-lg border-2 p-5 transition-all ${settings.billing_active_plan === 'fixed' && !settings.billing_pending_switch
                ? 'border-primary-500 ring-1 ring-primary-200'
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 md:p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <button
                ...
                className={`relative flex flex-col p-4 rounded-xl border-2 transition-all text-left ${settings.online_card_payment
              ...
              {/* Pay at Hotel */}
              <div
                className={`relative flex flex-col p-4 rounded-xl border-2 transition-all text-left cursor-pointer ${settings.pay_at_property_enabled
                    ? 'border-primary-500 bg-primary-50/30'
                    : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
              ...
              <button
                ...
                className={`relative flex flex-col p-4 rounded-xl border-2 transition-all text-left ${settings.bank_transfer
                    ? 'border-primary-500 bg-primary-50/30'
                    : 'border-gray-200 hover:border-gray-300'
                  }`}
              >
              ...
              <div className="sm:col-span-2">
                ...
                <div className="inline-flex rounded-lg border border-gray-300 p-0.5 bg-gray-50">
                  <button
                    ...
                    className={`px-3 py-1 text-[12px] font-medium rounded-md transition-colors ${(settings.payout_account_type || 'iban') === 'iban'
                  ...
                  <button
                    ...
                    className={`px-3 py-1 text-[12px] font-medium rounded-md transition-colors ${settings.payout_account_type === 'account_number'
                        ? 'bg-white text-gray-900 shadow-sm'
                        : 'text-gray-500 hover:text-gray-700'
                      }`}
                  >
