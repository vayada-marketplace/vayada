    ...
    <div className="max-w-2xl">
      <div className="bg-white rounded-lg border border-gray-200 p-5">
        ...
        <p className="text-[12px] text-gray-500 mt-0.5 mb-4">
          Payment methods and policies are managed in the Property Manager
        </p>
        ...
        <div className="bg-gray-50 rounded-lg border border-gray-200 p-6 text-center">
          ...
          <p className="text-[13px] font-medium text-gray-600">
            Go to PMS Settings to configure payments
          </p>
          <p className="text-[12px] text-gray-400 mt-0.5">
            Stripe, pay at property, and cancellation policies are configured in the Property
            Manager
          </p>
        </div>
      </div>
