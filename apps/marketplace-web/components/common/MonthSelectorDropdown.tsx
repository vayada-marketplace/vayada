...
export function MonthSelectorDropdown({ label, selected, onToggle }: MonthSelectorDropdownProps) {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        ...
        >
          <div className="px-5 py-2.5 text-gray-900 text-sm font-bold">Select Months</div>
