...
export function CollaborationCard({
  ...
  const shouldShowRatingPrompt =
    currentUserType === "hotel" && collaboration.status === "completed" && !collaboration.hasRated;
  ...
  const getTotalFollowers = () => {
    ...
    if (
      ...
      collaboration.creator?.audienceSize &&
      collaboration.creator.audienceSize > 0
    ) {
    ...
    >
      <div className="flex items-start gap-4">
            ...
            <div className="bg-amber-50 border-2 border-amber-300 rounded-lg p-4 max-w-xs shadow-sm">
              <div className="flex items-start gap-2 mb-2">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-amber-900 mb-1">Rate Your Experience</p>
                  <p className="text-xs text-amber-800 mb-3 leading-relaxed">
                    This collaboration is completed. Please rate your experience with a 1-5 star
                    rating and share your feedback.
                  </p>
                </div>
              </div>
              <Button
        ...
        {collaboration.status !== "pending" && !shouldShowRatingPrompt && (
          <div
            className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ${statusColor} flex-shrink-0`}
          >
