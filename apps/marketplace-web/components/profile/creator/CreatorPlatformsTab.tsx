    ...
    <div className="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-[0_4px_14px_rgba(0,0,0,0.04)]">
      ...
      <div className="flex items-center justify-between gap-4 p-4">
        <div className="flex items-center gap-3">
          <div
            className={`w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-sm text-white bg-gradient-to-br ${getPlatformGradient(platformName)}`}
          >
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                {editFormData.platforms[actualIndex]?.topCountries?.length ? (
                  <div className="space-y-2">
                    {editFormData.platforms[actualIndex].topCountries!.map(
                          ...
                          <div className="flex items-center gap-2">
                            <div className="flex items-center gap-1 rounded-md border border-gray-200 bg-white px-2 py-1">
                              <input
                                ...
                                inputMode="decimal"
                                value={
                                  country.percentage && country.percentage > 0
                                    ? country.percentage
                                    : ""
                                }
                                onChange={(e) => {
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {AGE_GROUP_OPTIONS.map((range) => {
                  const isSelected = editFormData.platforms[actualIndex]?.topAgeGroups?.some(
                    (a) => a.ageRange === range,
                  );
                  return (
                    <button
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Input
                  ...
                  type="number"
                  value={
                    editFormData.platforms[actualIndex]?.genderSplit?.male &&
                    editFormData.platforms[actualIndex].genderSplit!.male > 0
                      ? editFormData.platforms[actualIndex].genderSplit!.male
                      : ""
                  }
                  onChange={(e) => {
                ...
                <Input
                  ...
                  type="number"
                  value={
                    editFormData.platforms[actualIndex]?.genderSplit?.female &&
                    editFormData.platforms[actualIndex].genderSplit!.female > 0
                      ? editFormData.platforms[actualIndex].genderSplit!.female
                      : ""
                  }
                  onChange={(e) => {
              ...
              {editFormData.platforms[actualIndex]?.genderSplit &&
                editFormData.platforms[actualIndex].genderSplit!.male +
                  editFormData.platforms[actualIndex].genderSplit!.female >
                  100 && <p className="text-xs text-red-600 mt-1">Total &gt; 100%</p>}
            </div>
          </div>
        )}
      </div>
