                ...
                {creatorProfile.platforms && creatorProfile.platforms.length > 0 ? (
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
                    <p className="text-gray-500">
                      No platforms added yet. Edit your profile to add social media platforms.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                  ...
                  <p className="text-sm text-gray-700">
                    Add at least one platform with audience demographics to help match you with the
                    right properties.
                  </p>
                  ...
                  <div className="space-y-3 mt-4">
                    {PLATFORM_OPTIONS.map((platformName) => {
                      const platformsOfThisType = editFormData.platforms.filter(
                      ...
                      return (
                        <div
                          key={platformName}
                          className="border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-[0_4px_14px_rgba(0,0,0,0.04)]"
                        >
                              ...
                              <div>
                                ...
                                {hasPlatforms && (
                                  <p className="text-xs text-gray-500 mt-0.5">
                                    ...
                                    {platformsOfThisType.length === 1 ? "account" : "accounts"}{" "}
                                    added
                                  </p>
                                )}
                              </div>
                              ...
                              {platformsOfThisType.map((platform, idx) => {
                                ...
                                return (
                                  <div
                                    ...
                                    className="px-4 md:px-6 pb-5 pt-4"
                                  >
                                        ...
                                        {platform.handle && (
                                          <p className="text-xs text-gray-500 mt-0.5">
                                            {platform.followers > 0
                                              ? `${formatFollowersDE(platform.followers)} followers`
                                              : "No followers set"}
                                          </p>
                                        )}
                                      </div>
                                    ...
                                    <div className="space-y-3 mb-4">
                                      <Input
                                        ...
                                        value={
                                          actualIndex >= 0
                                            ? editFormData.platforms[actualIndex].handle
                                            : ""
                                        }
                                        onChange={(e) =>
                                          platformMgmt.updatePlatform(
                                            actualIndex,
                                            "handle",
                                            e.target.value,
                                          )
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        <Input
                                          ...
                                          value={
                                            actualIndex >= 0
                                              ? editFormData.platforms[actualIndex].followers || ""
                                              : ""
                                          }
                                          onChange={(e) =>
                                            platformMgmt.updatePlatform(
                                        ...
                                        <Input
                                          ...
                                          value={
                                            actualIndex >= 0
                                              ? editFormData.platforms[actualIndex]
                                                  .engagementRate || ""
                                              : ""
                                          }
                                          onChange={(e) => {
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-xl p-3">
                                      <button
                                        type="button"
                                        onClick={() =>
                                          platformMgmt.togglePlatformExpanded(actualIndex)
                                        }
                                        ...
                                        <div className="mt-4 space-y-4">
                                          ...
                                          <div className="space-y-2">
                                            <div className="flex items-center justify-between">
                                              <div>
                                                ...
                                                <p className="text-xs text-gray-500">
                                                  Select up to 3 countries with their audience
                                                  percentage
                                                </p>
                                              </div>
                                            </div>
                                            <div className="space-y-2">
                                              <input
                                                ...
                                                onChange={(e) =>
                                                  platformMgmt.handleCountryInputChange(
                                                    actualIndex,
                                                    e.target.value,
                                                  )
                                                }
                                              ...
                                              />
                                              {platformMgmt.getAvailableCountries(actualIndex)
                                                .length > 0 && (
                                                <div className="max-h-40 overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-sm">
                                                  {platformMgmt
                                                    .getAvailableCountries(actualIndex)
                                                    .map((country) => (
                                                      <button
                                                        key={country}
                                                        type="button"
                                                        onClick={() =>
                                                          platformMgmt.addCountryFromInput(
                                                            actualIndex,
                                                            country,
                                                          )
                                                        }
                                              ...
                                              {editFormData.platforms[actualIndex]?.topCountries
                                                ?.length ? (
                                                <div className="space-y-2">
                                                  {editFormData.platforms[
                                                    actualIndex
                                                ...
                                                <p className="text-xs text-gray-500">
                                                  Add up to 3 countries and set the audience % for
                                                  each.
                                                </p>
                                              )}
                                            </div>
                                          ...
                                          <div className="space-y-2">
                                            <div>
                                              ...
                                              <p className="text-xs text-gray-500">
                                                Select up to 3 age groups with their audience
                                                percentage
                                              </p>
                                            </div>
                                            <div className="flex flex-wrap gap-2">
                                              {AGE_GROUP_OPTIONS.map((range) => {
                                                const isSelected = editFormData.platforms[
                                                  actualIndex
                                                ]?.topAgeGroups?.some((a) => a.ageRange === range);
                                                return (
                                                  <button
                                                    key={range}
                                                    type="button"
                                                    onClick={() =>
                                                      platformMgmt.toggleAgeGroupTag(
                                                        actualIndex,
                                                        range,
                                                      )
                                                    }
                                          ...
                                          <div className="space-y-2">
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                              <Input
                                                ...
                                                type="number"
                                                value={
                                                  editFormData.platforms[actualIndex]?.genderSplit
                                                    ?.male &&
                                                  editFormData.platforms[actualIndex].genderSplit!
                                                    .male > 0
                                                    ? editFormData.platforms[actualIndex]
                                                ...
                                                onChange={(e) => {
                                                  ...
                                                  const cleanVal =
                                                    val === ""
                                                      ? ""
                                                      : val.replace(/^0+(?=\d)/, "") || val;
                                                  platformMgmt.updateGenderSplit(
                                                    actualIndex,
                                                    "male",
                                                    cleanVal === "" ? 0 : parseInt(cleanVal),
                                                  );
                                                }}
                                                placeholder="45"
                                                min={0}
                  ...
                  <div className="mt-6 flex items-center gap-3 rounded-2xl bg-gray-50 border border-gray-200 px-4 py-3 text-sm text-gray-700">
                    ...
                    <p className="leading-snug">
                      All data should be verifiable via platform insights (e.g., Instagram Insights,
                      YouTube Analytics).
                    </p>
                  </div>
                </div>
