          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {images.map((image, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`relative group aspect-square rounded-xl overflow-hidden shadow-sm border-2 transition-all ${isMain ? "border-primary-500 ring-2 ring-primary-100" : "border-gray-200 hover:border-primary-300"}`}
                >
                  <img src={image} alt={`Photo ${i + 1}`} className="w-full h-full object-cover" />
