        ...
        <div className="max-w-4xl mx-auto pt-4 pb-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-4xl font-extrabold text-gray-900">Export Your Data</h1>
            </div>
            <p className="text-lg text-gray-600">
              Download a copy of all your personal data (GDPR Article 20 - Right to Data
              Portability)
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded capitalize ${getStatusColor(exportStatus.status)}`}
                        >
                          {exportStatus.status}
                        </span>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm text-gray-900">
                        {formatDate(exportStatus.requested_at)}
                      </span>
                    </div>
                    ...
                    {exportStatus.processed_at && (
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm text-gray-900">
                          {formatDate(exportStatus.processed_at)}
                        </span>
                      </div>
                    )}
                  ...
                  {exportStatus.status === "completed" && (
                    <div className="mt-6 pt-4 border-t border-gray-200">
                      <p className="text-sm text-gray-600 mb-4">
                        Your data export is ready for download. The download link will expire on{" "}
                        {formatDate(exportStatus.expires_at)}.
                      </p>
                      <button
                        onClick={() => {
                  ...
                  {(exportStatus.status === "pending" || exportStatus.status === "processing") && (
                    <div className="mt-6 pt-4 border-t border-gray-200">
                      <p className="text-sm text-gray-600">
                        Your export is being prepared. This may take a few minutes. You will be
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Request a copy of all your personal data in a machine-readable format (JSON). The
                  export will be available for download for 7 days.
                </p>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                <h3 className="text-sm font-semibold text-gray-900 mb-2">
                  About Data Portability (GDPR Article 20)
                </h3>
                <p className="text-sm text-gray-600">
                  Under GDPR, you have the right to receive a copy of your personal data in a
                  structured, commonly used, and machine-readable format. This allows you to easily
                  transfer your data to another service provider if you choose.
                </p>
              </div>
            </div>
          )}
