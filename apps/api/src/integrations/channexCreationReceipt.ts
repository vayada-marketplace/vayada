...
/** Same bounded reader shared with ARI; creation-specific evidence stays separate. */
export function readChannexCreationResponse(response: Response) {
  return readChannexResponse(response, sanitizeChannexCreationResponse);
}
